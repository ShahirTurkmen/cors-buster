...
async function service(req, res) {
  ...
  if (parts === null) {
    ...
    <html>
      ...
      <h1>CORS Buster! 👻&#x20E0;</h1>
      <h2>See docs: <a href="https://npmjs.org/package/${
        pkg.name
      }">https://npmjs.org/package/${pkg.name}</a></h2>
      <h2>Authenticity</h2>
      ...
      Example: ${
        process.env.NOW_URL
      }/github.com/wmhilton/cors-buster?service=git-upload-pack
  ...
  let f = await fetch(`https://${pathdomain}/${remainingpath}`, {
    method: req.method,
    headers,
